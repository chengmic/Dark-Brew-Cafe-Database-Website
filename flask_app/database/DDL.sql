...
(1, 'Billy', 'Bob', 'billybob@hello.com', '1991-01-01'),
(2, 'Asami', 'Sato', 'asamisato@hello.com', '1994-02-03'),
(3, 'Benjamin', 'Sisko', 'bensis@hello.com', '1980-05-04'),
(4, 'Missy', 'Franklin', 'mfranklin12@hello.com', '1977-12-15');
...
(1, '2022-01-02', 1, 1, 5.00),
(2, '2022-01-03', 1, 1, 3.00),
(3, '2022-01-03', 3, 2, 49.00),
(4, '2022-01-04', 4, NULL, 17.00),
(5, '2022-01-04', 5, 3, 17.00),
(6, '2022-01-05', 5, 3, 9.00),
(7, '2022-01-06', 3, 2, 9.50),
(8, '2022-01-07',  2, 4, 7.00);
...
INSERT INTO `Order_Details` (`order_details_id`, `order_id`, `item_id`, `unit_cost`, `item_quantity`, `item_total`) VALUES
(1, 1, 1, '1.00', 2, '2.00'),
(2, 1, 5, '3.00', 1, '3.00'),
(3, 2, 3, '3.00', 1, '3.00'),
(4, 3, 3, '3.00', 2, '6.00'),
...
--
ALTER TABLE `Order_Details`
  ADD CONSTRAINT `fk_Order_Details_Items` FOREIGN KEY (`item_id`) REFERENCES `Items` (`item_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
